...
namespace ThuyTo.Areas.Admin.Controllers
{
    ...
    public class FeeShipController : Controller
	{
        ...
        [AdminAuthentication]
        public IActionResult AddFeeship(int provinceid, int districtsid, int communeid, decimal? shipprice)
		{
			try
			{
				...
				if(IsExists == null)
				{
                    ...
                    feeship.ShipPrice = shipprice.Value;
				...
				{
					IsExists.ShipPrice = shipprice.Value;
